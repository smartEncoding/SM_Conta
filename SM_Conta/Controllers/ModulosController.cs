...
namespace SM_Conta.Controllers
{
    public class ModulosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion")] Modulos modulos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion")] Modulos modulos)
        {
            if (ModelState.IsValid)
            {
